...
export default function Album() {
    ...
    const handleAddCourse = async (taskId) => {
      ...
      try {
        await axios.get('/api/getcookie3', {
          params: {
            notesId: taskId,
          },});
      } catch (error) {
      ...
      <main>
        ...
        >
          <Container maxWidth="sm">
            ...
            >
                <RouterLink to="/CreateNotes">
              <Button variant="contained"  > Add New Note</Button></RouterLink>
              
              <Button variant="outlined"  onClick={handleScroll}>Previous Notes</Button>
